...
#define MQTT_ID        "IoT-Client_X_Area51" // Your MQTT ID
#define MQTT_LOG_ENABLED 1 // Enable MqttClient logs
#define HW_UART_SPEED    9600L  // Uart Speed
