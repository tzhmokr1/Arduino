...
#define MQTT_ID        "IoTx" // Your MQTT ID from the list
    ...
    if (newGpsData)
    {
      ...
      for (int n = 0; n < gpsRaw.length(); n++)
      {
        ...
        if (gps.encode(gpsRaw.charAt(n)))
        {
          ...
          {
            // todo: Decode and publish longitude/latitude here
          }
          else
          {
          ...
          {
            // todo: decode and publish speed here
          }
          else
          {
